...
public class ModeloDonacion extends Donacion{
    ...
    public ModeloDonacion(int iddonacion, String detallePro, Date fechaEntrega, String motivodonacion, int idpersona) {
        super(iddonacion, detallePro, fechaEntrega, motivodonacion, idpersona);
    }
